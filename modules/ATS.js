        ...
        if (message.channel.parent.id == config.supportID) {
            ...
            collector.on('collect', collected => {
                ...
                switch (collected.content) {
                    case "1":
                    if (Math.floor(newdate - new Date(collected.author.createdAt).valueOf()) < 1 ) return message.channel.send("It seems that your account is younger than 24hours. You'll have to wait until your account is at least a day old to get a Trial key.")
